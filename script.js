document.addEventListener('DOMContentLoaded', function () {
  ...
  function clearFormErrors(form) {
    ...
    const existingMessages = form.querySelectorAll('.form-success-message, .form-global-error');
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'cec145f5-50b5-4ebb-a6c3-adb86c5706e3',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'cec145f5-50b5-4ebb-a6c3-adb86c5706e3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'cec145f5-50b5-4ebb-a6c3-adb86c5706e3';
